...
@Component({
  selector: 'app-candidates-per-test',
  templateUrl: './candidates-per-test.component.html',
  styleUrls: ['./candidates-per-test.component.css']
})
export class CandidatesPerTestComponent implements OnInit {
  my_data = {
