...
@Component({
  selector: 'app-applicants-per-period',
  templateUrl: './applicants-per-period.component.html',
  styleUrls: ['./applicants-per-period.component.css']
})
export class ApplicantsPerPeriodComponent implements OnInit {
