...
@Component({
  selector: 'app-answered-questions-per-test',
  templateUrl: './answered-questions-per-test.component.html',
  styleUrls: ['./answered-questions-per-test.component.css']
})
export class AnsweredQuestionsPerTestComponent implements OnInit {
  ...
  public setMyData(): any {
    this.dashboardService.getAnsweredQuestionsTestForOffer(this.current_offer_id).subscribe(
      (data: any) => {
        this.my_data = data
        console.log(data)
