...
@Component({
  selector: 'app-success-per-test',
  templateUrl: './success-per-test.component.html',
  styleUrls: ['./success-per-test.component.css']
})
export class SuccessPerTestComponent implements OnInit {
