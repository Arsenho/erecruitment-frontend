...
@Component({
  selector: 'app-participant-percentage-per-test',
  templateUrl: './participant-percentage-per-test.component.html',
  styleUrls: ['./participant-percentage-per-test.component.css']
})
export class ParticipantPercentagePerTestComponent implements OnInit {
  ...
  public setMyData(): any {
    this.dashboardService.getParticipantPercentagePerTest(this.offer_id).subscribe(
      (data: any) => {
        this.my_data = data
        console.log(data)
        this.lineChartLabels = data.labels
        this.barChartLabels = data.labels
        let allChartData = data.allChartData
        for(let item of allChartData){
